...
export function WorksPageShell({ children }: WorksPageShellProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="works-route-blob works-route-blob-a pointer-events-none fixed z-0 h-[1180px] w-[1180px] rounded-full opacity-75"
        style={blobAStyle}
      />
      <div
        className="works-route-blob works-route-blob-b pointer-events-none fixed z-0 h-[1080px] w-[1080px] rounded-full opacity-68"
        style={blobBStyle}
      />
