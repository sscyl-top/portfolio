...
export const resume = {
  ...
  strengths: [
    "综合 5 年+经验：曾作为年销亿级全球全产业链品牌「极克 Jetfly」的唯一首席设计师，以一人设计团队模式独立构建并落地品牌全链路视觉体系，统筹品牌升级、全栈电商、产品 ID、国际赛事、商业空间及子品牌孵化等全链视觉工作。",
    ...
    "跨部门协同与落地：具备 Web 视觉设计与落地能力，可进行 vibe coding 式页面搭建与设计实现；同时具备短视频剪辑与动效表达能力，支持品牌在多平台、多端视觉系统、全球化商业与线下空间项目中实现一致性视觉管理与商业化转支持。",
  ...
  experience: [
    {
      ...
      points: [
        "品牌视觉重塑（VI/CI）：独立主导全球品牌「JetFly」极克的视觉重塑，视觉系统全套升级，搭建覆盖全渠道的品牌视觉体系，支撑其有全球市场的产品溢价；建立视觉统一的品牌视觉系统，为全终端网络及连锁门店的视觉应用建立标准。",
        "全渠道电商视觉统筹：统筹管理国内外 6+ 电商渠道（天猫 / 京东 / Amazon / 独立站）视觉系统。通过 AIGC 辅助场景合成，将详情页静默转化率提升 40%、大幅降低外站素材制作成本、深度拆解产品卖点，直接覆盖能全球亿级销售额。",
        "新品 ID 设计与包装工程：独立操刀 3 款年度旗舰新品 ID 设计及全系包装工程，统一全球 10+ 国家、100+ 经销商物料视觉标准，杜绝了品牌形象碎片化；打通从产品研发到消费终端的视觉闭环。",
        "赛事与展会视觉整合：输出动力冲浪板赛事涂装方案，并统筹比赛现场全部展示物料（大型行架 / 队旗 / 展陈 / 颁奖背景等）；主导交广等国际级展会的跨岗位视觉设计，强化品牌在专业领域的硬核认知。",
        "商业空间与跨界品牌建设（JetFly Coffee）：全资负责深圳南山蛇口 K11 ECOAST 旗舰店视觉监理，还原品牌极客科技调性，打造全球首家标杆级体验空间。负责规划集成自有咖啡品牌「JetFly Coffee」的全套设计，涵盖咖啡包装、店内外环境视觉及活动传播。",
      ],
    },
    {
      ...
      points: [
        "品牌设计：根据公司定位及传播方向，优化品牌全案与宣传物料（节假日活动海报、产品包装说明书、周年庆等），确保视觉统一。",
        "电商设计：协同完成主流电商平台店铺设计（主图、SKU、详情、首页、大促活动图、产品定制设计等），适配 Web & 移动端。",
        "设计成果：协同全面提升品牌视觉受客效果。主图在天猫、京东点击率破公司纪录，独立负责拼多多新店设计，三个月销量破万。",
      ],
    },
  ],
  campus: [
    {
      ...
      description: "负责品牌视觉设计/酒品包装设计，创意及绘制能力受到团队认可；协同团队落地线下传播方案与推广预算，市场反馈较好。",
    },
    {
      company: "武汉楚德宝智能设备有限公司",
      title: "设计组长/副店长",
      period: "2023.1 - 2023.3",
      description: "统筹设计师团队管理与人员招聘及薪酬发放；接进件审核，独立处理大单及客诉售后问题，期间经手金额 20w+。",
    },
    {
      company: "维沃移动通信有限公司 vivo",
      title: "主题 UI 设计师",
      period: "2022.9 - 2022.12",
      description: "特邀签约成为 vivo 主题设计师，全链路把控主题开发、测试、发布，通过视觉框架升级打造差异化体验，增强用户粘性。",
    },
    {
      company: "成都艺天创意广告有限公司",
      title: "广告设计师",
      period: "2021.8 - 2022.8",
      description: "对接客户：负责广告设计全流程及售后引导；同时兼任多家电商品牌（美豪视觉、雨丽视觉、糖果品牌设计等）设计师。",
    },
  ],
  education: {
    school: "毕节学院",
